...
export async function markRequestStarted(productIdentifier: ProductIdentifier): Promise<void> {
...
export async function markRequestCompleted(productIdentifier: ProductIdentifier): Promise<void> {
    await db.productRequests.delete([productIdentifier.asin, productIdentifier.marketplaceId]);
}
