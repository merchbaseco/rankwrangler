...
export const DebugWidget = () => {
    ...
    const { queueCount } = useProductRequestQueueCount();
        ...
        <div className="fixed bottom-4 right-4 z-[10000] font-sans">
            ...
            >
                ...
                <div className="flex items-center gap-2 p-2">
                    <span className="text-xs font-medium text-gray-800">Rank Wrangler</span>
                </div>
                ...
                <div className="p-2 space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-bold text-gray-900">{cacheSize ?? 0}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-bold text-gray-900">{queueCount ?? 0}</span>
                    </div>
