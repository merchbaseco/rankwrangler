...
and returns an intermediate WebP. RankWrangler crops its visible alpha bounds, scales the subject as
large as its aspect ratio allows, and centers it on a transparent 128×128 WebP canvas in R2. A sparse
