        ...
        <div className="flex min-h-0 flex-1 flex-col gap-3">
            <Frame>
                ...
                {isLicenseLoading && isKeepaLoading ? (
                    <p className="px-4 py-3 text-sm text-[#857869]">Loading runtime stats...</p>
                ) : (
            ...
            <JobExecutionsPanel className="mt-0 min-h-0 flex-1" rowsClassName="max-h-[420px]" />
        </div>
    );
}
...
const StatCard = ({
    ...
    return (
        <div className="rounded-lg border border-[rgba(20,18,16,0.08)] bg-white px-3 py-3">
            <p className="stat-value text-2xl font-semibold text-[#1C1917]">{value}</p>
