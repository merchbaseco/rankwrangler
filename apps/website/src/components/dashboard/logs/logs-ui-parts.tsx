...
export const LogDetails = ({ log }: { log: EventLogRow | null }) => {
    if (!log) {
        return <p className="p-3 text-xs text-muted-foreground">Select a row to inspect metadata.</p>;
    }

    return (
        <div className="space-y-2 p-3">
            <p className="font-mono text-xs uppercase tracking-[0.12em] text-muted-foreground">Log details</p>
