			...
			<div className="relative overflow-hidden rounded-lg border border-border">
				...
				>
					...
					<path
						...
						style={{ animation: 'sync-area-pulse 2.5s ease-in-out infinite' }}
					/>
					<path
						d={SYNC_WAVE_PATH}
						fill="none"
						...
						strokeDashoffset="0"
						style={{ animation: 'sync-line-draw 2.5s ease-in-out infinite' }}
					/>
					<rect
						x={-100}
						y={0}
						...
						style={{ animation: 'sync-sweep 2.5s ease-in-out infinite' }}
					/>
				</svg>
