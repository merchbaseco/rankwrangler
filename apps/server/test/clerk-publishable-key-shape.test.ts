...
const TEST_ARM_KEY = 'pk_test_cmFua3dyYW5nbGVyLXRlc3QuY2xlcmsuYWNjb3VudHMuZGV2JA';
...
describe('committed Clerk publishable keys', () => {
    ...
    it('keeps the test arm a fake domain rather than a real instance', () => {
        ...
        expect(describeKey(TEST_ARM_KEY).decoded).toBe('rankwrangler-test.clerk.accounts.dev$');
    });
});
