...
export const env = createEnv({
    server: {
        ...
        MERCHBASE_CLERK_PUBLISHABLE_KEY: z
            .string()
            .min(1, 'MERCHBASE_CLERK_PUBLISHABLE_KEY is required'),
        ...
        RANKWRANGLER_CLERK_AUTHORIZED_PARTIES: z
            .string()
            .min(1, 'RANKWRANGLER_CLERK_AUTHORIZED_PARTIES is required'),
        RANKWRANGLER_CLERK_WEBHOOK_SIGNING_SECRET: isProduction
            ? z
                  .string()
                  .min(1, 'RANKWRANGLER_CLERK_WEBHOOK_SIGNING_SECRET is required in production')
        ...
        RANKWRANGLER_TYPESAFE_API_KEY: z.string().optional(),
        RANKWRANGLER_R2_ACCOUNT_ID: z.string().min(1),
        RANKWRANGLER_R2_BUCKET_NAME: z.string().min(1),
        RANKWRANGLER_CUTOUT_TRANSFORM_ORIGIN: z.url(),
        RANKWRANGLER_CUTOUT_PUBLIC_ORIGIN: z.url(),
        RANKWRANGLER_R2_ACCESS_KEY_ID: z.string().optional(),
        RANKWRANGLER_R2_SECRET_ACCESS_KEY: z.string().optional(),
        ...
        RANKWRANGLER_DATABASE_MIGRATION_TARGET: z
            .enum(['pre-cutover', 'latest'])
            .default('pre-cutover'),
    ...
    runtimeEnv: {
        ...
        RANKWRANGLER_CLERK_WEBHOOK_SIGNING_SECRET:
        ...
        RANKWRANGLER_TYPESAFE_API_KEY: process.env.RANKWRANGLER_TYPESAFE_API_KEY,
        RANKWRANGLER_R2_ACCOUNT_ID: process.env.RANKWRANGLER_R2_ACCOUNT_ID,
        RANKWRANGLER_R2_BUCKET_NAME: process.env.RANKWRANGLER_R2_BUCKET_NAME,
        RANKWRANGLER_CUTOUT_TRANSFORM_ORIGIN: process.env.RANKWRANGLER_CUTOUT_TRANSFORM_ORIGIN,
        RANKWRANGLER_CUTOUT_PUBLIC_ORIGIN: process.env.RANKWRANGLER_CUTOUT_PUBLIC_ORIGIN,
        RANKWRANGLER_R2_ACCESS_KEY_ID: process.env.RANKWRANGLER_R2_ACCESS_KEY_ID,
        RANKWRANGLER_R2_SECRET_ACCESS_KEY: process.env.RANKWRANGLER_R2_SECRET_ACCESS_KEY,
